        ...
        <div className='mt-24 mb-36'>
            ...
            <div className='grid grid-cols-2 gap-16 container mx-auto mt-16'>
                <div className='h-64 flex items-center rounded-2xl bg-orange-100'>
                    <img className='w-80 relative right-6 top-6 ' src="https://i.ibb.co/cy2bTKP/pngwing-com.png" alt="" />
                    <div>
                ...
                <div className='h-64 flex items-center bg-teal-100 rounded-2xl'>
                    <img className='w-80 relative right-6 top-6' src="https://i.ibb.co/Vp4Cmy9/pngwing-com-1.png" alt="" />
                    <div>
